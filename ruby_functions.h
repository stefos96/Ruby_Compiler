#ifndef __SMALLLANG_H__
#define __SMALLLANG_H__

/* Definition of the supported types*/
typedef enum {
	type_error, type_integer, type_real, type_boolean
} ParType;

typedef enum {
	type_variable, type_function
} id_type;

/* These are needed here since they act as symbol attributes. */
